...
function Card({width,start,para,hover}) {
  return (
    <div className={`w-full bg-black ${hover} ${width}`}>
    <div className={` max-w-screen-xl flex-col justify-between text-white rounded-xl p-5 flex min-h-[30rem] `}>
   <div>
    ...
    start===true && (   <> <h1 className='text-6xl font-semiblod leading-none '> Start a  project</h1>
        <button className='flex  rounded-full mt-5 text-black bg-zinc-100 border-zinc-200 py-3 px-3 m-2'> contact us <div className="mx-2 my-1"><FaArrowRight /></div> </button> </>) 
    }
